...
<aside id="sidebar" class="sidebar flex flex-col fixed top-0 left-0 h-full w-72 bg-[#800020] z-50 shadow-xl overflow-y-auto sidebar-hidden md:sidebar-visible md:translate-x-0">
    ...
    <nav class="flex-1 py-4">
        ...
        <a href="student_dashboard.php" class="flex items-center gap-3 mx-3 px-3 py-3 rounded-lg transition-all <?php echo $current_page == 'student_dashboard.php' ? 'nav-active' : 'nav-inactive hover:bg-[#600018]'; ?>"><i class="fas fa-home w-5"></i><span class="text-sm font-medium">Home</span></a>
        <a href="student_qr.php" class="flex items-center gap-3 mx-3 px-3 py-3 rounded-lg transition-all <?php echo $current_page == 'student_qr.php' ? 'nav-active' : 'nav-inactive hover:bg-[#600018]'; ?>"><i class="fas fa-qrcode w-5"></i><span class="text-sm font-medium">QR Code</span></a>
        <a href="student_record.php" class="flex items-center gap-3 mx-3 px-3 py-3 rounded-lg transition-all <?php echo $current_page == 'student_record.php' ? 'nav-active' : 'nav-inactive hover:bg-[#600018]'; ?>"><i class="fas fa-notes-medical w-5"></i><span class="text-sm font-medium">Records</span></a>
        <a href="student_appointments.php" class="flex items-center gap-3 mx-3 px-3 py-3 rounded-lg transition-all <?php echo $current_page == 'student_appointments.php' ? 'nav-active' : 'nav-inactive hover:bg-[#600018]'; ?>"><i class="fas fa-calendar-alt w-5"></i><span class="text-sm font-medium">Appointments</span></a>
        <a href="student_announcement.php" class="flex items-center gap-3 mx-3 px-3 py-3 rounded-lg transition-all <?php echo $current_page == 'student_announcement.php' ? 'nav-active' : 'nav-inactive hover:bg-[#600018]'; ?>"><i class="fas fa-newspaper w-5"></i><span class="text-sm font-medium">News</span></a>
        <a href="student_notifications.php" class="flex items-center gap-3 mx-3 px-3 py-3 rounded-lg transition-all <?php echo $current_page == 'student_notifications.php' ? 'nav-active' : 'nav-inactive hover:bg-[#600018]'; ?>"><i class="fas fa-bell w-5"></i><span class="text-sm font-medium">Notifications</span></a>
        <a href="student_settings.php" class="flex items-center gap-3 mx-3 px-3 py-3 rounded-lg transition-all <?php echo $current_page == 'student_settings.php' ? 'nav-active' : 'nav-inactive hover:bg-[#600018]'; ?>"><i class="fas fa-user-circle w-5"></i><span class="text-sm font-medium">Profile</span></a>
        <div class="border-t border-[#600018] my-4 mx-3"></div>
        <a href="student_logout.php" class="flex items-center gap-3 mx-3 px-3 py-3 rounded-lg text-white/70 hover:text-white hover:bg-[#600018] transition-all"><i class="fas fa-sign-out-alt w-5"></i><span class="text-sm font-medium">Sign Out</span></a>
    </nav>
    <div class="p-4 border-t border-[#600018] mt-auto"><p class="text-[10px] text-white/40 text-center">PUPBC Carelink v1.0<br>© <?php echo date('Y'); ?> All rights reserved</p></div>
</aside>
